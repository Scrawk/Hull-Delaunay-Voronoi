...
If you are interested in computational geometry or other triangulation algorithms you might what to check the [CGALDotNet](https://github.com/Scrawk/CGALDotNet) project out.
